"""
Author: XavierZXY 
Date: 2024-03-08 14:29:39
LastEditors: XavierZXY 
Description: Traing resnet using pytorch

Copyright (c) 2024 by XavierZXY, All Rights Reserved. 
"""
...
[2] https://nn.labml.ai/resnet/index.html
...
def train(epoch):
    ...
    for batch_index, (images, labels) in enumerate(cifar10_training_loader):
        ...
        # record the last layer's gradient norm
...
def eval_training(epoch=0, tb=True):
    ...
    if tb:
        writer.add_scalar(
            "Test/Average loss", test_loss / len(cifar10_test_loader.dataset), epoch
        )
        writer.add_scalar(
            "Test/Accuracy", correct.float() / len(cifar10_test_loader.dataset), epoch
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="use fbs method to boost or not",
    )
