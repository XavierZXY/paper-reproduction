...
def get_args_parser():
    ...
    parser.add_argument(
        "--no_continue_inf", action="store_false", dest="if_continue_inf"
    )
    ...
    parser.add_argument(
        "--no_random_cls_token_position",
        action="store_false",
        dest="if_random_cls_token_position",
    )
    ...
    parser.add_argument(
        "--no_random_token_rank", action="store_false", dest="if_random_token_rank"
    )
...
def main(args):
    ...
    if args.eval:
        ...
        print(
            f"Accuracy of the ema network on the {len(dataset_val)} test images: {test_stats['acc1']:.1f}%"
        )
        return
